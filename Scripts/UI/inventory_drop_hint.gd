...
func _physics_process(delta):
	...
	if InputMap.has_action("inventory_drop"):
		if not InputMap.action_get_events("inventory_drop").is_empty():
			var event = InputMap.action_get_events("inventory_drop")[0]
	...
	if InputMap.has_action("inventory_drop"):
		if not InputMap.action_get_events("inventory_drop").is_empty():
			var event = InputMap.action_get_events("inventory_drop")[1]
