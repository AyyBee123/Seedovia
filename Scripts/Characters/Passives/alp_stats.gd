...
func set_stats():
	...
	player._player_stats.max_health = 1
	player._player_stats.leaf_hearts = 2
	player._player_stats.speed = 400.0
	...
	player._player_stats.stats["Weapon_Blast_Radius"]["x"] = 1.25
	player._player_stats.stats["Weapon_Size"]["x"] = 1.25
